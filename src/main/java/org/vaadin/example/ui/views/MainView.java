...
import org.vaadin.example.entities.authorize.User;
...
public class MainView extends AppLayout {
    ...
    private Component[] createMenuItems() {
        Accesos user = VaadinSession.getCurrent().getAttribute(Accesos.class);
        return authService.getAuthorizedRoutes(user.getRol()).stream()
