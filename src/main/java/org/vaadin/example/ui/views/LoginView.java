...
public class LoginView extends VerticalLayout {
    ...
    private void buildUI() {
        ...
        Button restoreLogin = new Button("Crear nueva cuenta" ,
                event -> loginForm.setEnabled(true));
        ...
        Button showAyuda = new Button(new Icon(VaadinIcon.INFO_CIRCLE),
                event -> loginForm.setError(true));
        showAyuda.addThemeVariants(ButtonVariant.LUMO_TERTIARY);

        HorizontalLayout horizontal = new HorizontalLayout();
        horizontal.add(restoreLogin, showAyuda);
