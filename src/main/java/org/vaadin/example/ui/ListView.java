...
public class ListView extends VerticalLayout {
    ...
    private void saveContact(ContactForm.SaveEvent evt) {
        if (evt.getContact().getIdUsuario() == null) {
            usuarioDao.insertar(evt.getContact());
        } else {
            usuarioDao.actualizar(evt.getContact());
        }
        updateList();
        closeEditor();
    }
    ...
    private void deleteContact(ContactForm.DeleteEvent evt) {
        usuarioDao.eliminar(evt.getContact());
        updateList();
        closeEditor();
    }
    ...
    private void updateList() {
        grid.setItems(usuarioDao.listar(filterText.getValue()));
    }
